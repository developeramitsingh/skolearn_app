      ...
      <SafeAreaView style={registerStyles.container}>
        ...
        <View style={registerStyles.registerContainter}>
            ...
            <View style= {{flex: 0, flexDirection: 'row', alignItems: 'center'}}>
                ...
                <Text style={COMMON_STYLES.BODY_TEXT_WHITE}>{LANGUAGES_DATA[lang]?.REGISTER?.TERMS_TXT} <Text style={COMMON_STYLES.LINK_TEXT} onPress={()=> {
                    navigation.navigate(Constant.ROUTES.WEB_VIEW, { webViewUrl: `${BACKEND_URL}/policy/${Constant.POLICY.TERMS_COND}` });
                }}> {LANGUAGES_DATA[lang]?.REGISTER?.TERMS_LINK}</Text></Text>
            </View>
