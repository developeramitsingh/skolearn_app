    ...
    [Constant.LANGUAGES.ENGLISH]: {
        ...
        DASHBOARD:{
            [Constant.SCREENS.TEST_LIST]: {
                ...
                CAT_TABS: {
                    [Constant.DASHBOARD_TEST_GROUP_TABS[0].key]: Constant.DASHBOARD_TEST_GROUP_TABS[0].name,
                    [Constant.DASHBOARD_TEST_GROUP_TABS[1].key]: Constant.DASHBOARD_TEST_GROUP_TABS[1].name,
                    [Constant.DASHBOARD_TEST_GROUP_TABS[2].key]: Constant.DASHBOARD_TEST_GROUP_TABS[2].name,
                    [Constant.DASHBOARD_TEST_GROUP_TABS[3].key]: Constant.DASHBOARD_TEST_GROUP_TABS[3].name,
                    [Constant.DASHBOARD_TEST_GROUP_TABS[4].key]: Constant.DASHBOARD_TEST_GROUP_TABS[4].name,
                    [Constant.DASHBOARD_TEST_GROUP_TABS[5].key]: Constant.DASHBOARD_TEST_GROUP_TABS[5].name,
                    [Constant.DASHBOARD_TEST_GROUP_TABS[6].key]: Constant.DASHBOARD_TEST_GROUP_TABS[6].name,
                    [Constant.DASHBOARD_TEST_GROUP_TABS[7].key]: Constant.DASHBOARD_TEST_GROUP_TABS[7].name,
                    [Constant.DASHBOARD_TEST_GROUP_TABS[8].key]: Constant.DASHBOARD_TEST_GROUP_TABS[8].name,
                    [Constant.DASHBOARD_TEST_GROUP_TABS[9].key]: Constant.DASHBOARD_TEST_GROUP_TABS[9].name,
                    [Constant.DASHBOARD_TEST_GROUP_TABS[10].key]: Constant.DASHBOARD_TEST_GROUP_TABS[10].name,
                    [Constant.DASHBOARD_TEST_GROUP_TABS[11].key]: Constant.DASHBOARD_TEST_GROUP_TABS[11].name,
                    [Constant.DASHBOARD_TEST_GROUP_TABS[12].key]: Constant.DASHBOARD_TEST_GROUP_TABS[12].name,
                    [Constant.DASHBOARD_TEST_GROUP_TABS[13].key]: Constant.DASHBOARD_TEST_GROUP_TABS[13].name,
                },
                [Constant.TEST_TYPES.LIVE]: {
